        ...
        <div class="card-body">
            <div class="d-md-flex gap-4 align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <button type="button" class="btn btn-primary" id="AddCategoryBtn">Add Sleeve</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <form action="{{ route('addSleeve') }}" method="post" id="sleeve_form">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Add Sleeve</h5>
...
<script src="{{asset('backend/js/sleeve.js')}}"></script>
@endpush