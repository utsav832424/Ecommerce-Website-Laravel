...
@section('title','Bigger Admin || DASHBOARD')
                        ...
                        <div class="d-md-flex align-items-center mb-3">
                            <div class="d-flex align-items-center">
                                <div class="display-7 me-3">
                                    <i class="bi bi-bag-check me-2 text-success"></i> ₹{{$sale->total}}
                                </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="d-flex mb-3">
                            <div class="display-7">₹{{$sale->total}}</div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0">
                                <div class="card-body text-center">
                                    ...
                                    <div class="text-muted">{{$pending}} New Items</div>
                                    <div class="progress mt-3" style="height: 5px">
                        ...
                        <div class="col-md-6">
                            <div class="card border-0">
                                <div class="card-body text-center">
                                    ...
                                    <div class="text-muted">{{$deliverd}} Upgraded Boxed</div>
                                    <div class="progress mt-3" style="height: 5px">
