...
@section('title','Bigger Admin || COLOR')
        ...
        <div class="card-body">
            <div class="d-md-flex gap-4 align-items-center">
                ...
                <div class="dropdown ms-auto">
                    <button type="button" class="btn btn-primary" id="AddCategoryBtn">Add Quantity</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <form action="{{ route('qty_adjustment') }}" method="post" id="qtyadjustment_form">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <select class="select2-example" id="product-name" class="col-form-label">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control number-field" id="quantity" name="quantity">
                        </div>
                    </div>
...
<script src="{{asset('backend/js/qtyadjustment.js')}}"></script>
@endpush