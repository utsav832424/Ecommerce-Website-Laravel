...
<head>
    ...
    <title>Login - Bigger | Admin Login</title>
            ...
            <div class="card">
                <div class="row g-0">
                        ...
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
                                <div class="d-block d-lg-none text-center text-lg-start">
                                    <img width="120" src="{{asset('frontend/img/bigger.png')}}" alt="logo">
                                </div>
                                <div class="my-5 text-center text-lg-start">
                                    <h1 class="display-8">Sign In</h1>
                                    <p class="text-muted">Sign in to Bigger to continue</p>
                                </div>
                                <form class="mb-5" method="POST" action="{{route('loginsubmit')}}">
                                    @csrf
                                    <div class="mb-3">
                                        <input type="email" class="form-control" placeholder="Enter email" autofocus required name="email">
                                    </div>
                                    <div class="mb-3">
                    ...
                    <div class="col d-none d-lg-flex border-start align-items-center justify-content-between flex-column text-center">
                        ...
                        <div>
                            <h3 class="fw-bold">Welcome to Bigger!</h3>
