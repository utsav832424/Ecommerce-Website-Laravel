<div class="menu">
    <div class="menu-header">
        <a href="{{url('admin/dashboard')}}" class="menu-header-logo">
            <img src="{{asset('frontend/img/bigger.png')}}" alt="logo">
        </a>
        <a href="{{url('admin/dashboard')}}" class="btn btn-sm menu-close-btn">
            <i class="bi bi-x"></i>
        </a>
    </div>
    <div class="menu-body">
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a href="{{url('admin/setting')}}" class="dropdown-item d-flex align-items-center">
                    <i class="bi bi-gear dropdown-item-icon"></i> Settings
                </a>
                <a href="{{url('admin/logout')}}" class="dropdown-item d-flex align-items-center text-danger">
    ...
    <li>
        ...
        <ul>
            {{-- <li>
                <a class="{{request()->is('admin/categories') ? 'active':''}}" href="{{url('admin/categories')}}">Categories</a>
            </li> --}}
            <li>
                <a class="{{request()->is('admin/product') ? 'active':''}}" href="{{url('admin/product')}}">List</a>
            </li>
            <li>
                <a class="{{request()->is('admin/qty_adjustment') ? 'active':''}}" href="{{url('admin/qty_adjustment')}}">Quantity Adjustment</a>
            </li>
            {{-- <li>
    ...
    <li>
        ...
        <ul>
            <li>
                <a class="{{request()->is('admin/categories') ? 'active':''}}" href="{{url('admin/categories')}}">Main Category</a>
            </li>
            <li>
                <a class="{{request()->is('admin/sub_categories') ? 'active':''}}" href="{{url('admin/sub_categories')}}">Sub Category</a>
            </li>
            <li>
                <a class="{{request()->is('admin/fabric') ? 'active':''}}" href="{{url('admin/fabric')}}">FABRIC</a>
            </li>
            <li>
                <a class="{{request()->is('admin/color') ? 'active':''}}" href="{{url('admin/color')}}">COLORS</a>
            </li>
            <li>
                <a class="{{request()->is('admin/size') ? 'active':''}}" href="{{url('admin/size')}}">SIZE</a>
            </li>
            <li>
                <a class="{{request()->is('admin/occasion') ? 'active':''}}" href="{{url('admin/occasion')}}">OCCASION</a>
            </li>
            <li>
                <a class="{{request()->is('admin/pattern') ? 'active':''}}" href="{{url('admin/pattern')}}">PATTERN</a>
            </li>
            <li>
                <a class="{{request()->is('admin/work') ? 'active':''}}" href="{{url('admin/work')}}">WORK</a>
            </li>
            <li>
                <a class="{{request()->is('admin/sleeve_type') ? 'active':''}}" href="{{url('admin/sleeve_type')}}">SLEEVE</a>
            </li>
            <li>
                <a class="{{request()->is('admin/wash') ? 'active':''}}" href="{{url('admin/wash')}}">WASH</a>
            </li>
            <li>
                <a class="{{request()->is('admin/hook') ? 'active':''}}" href="{{url('admin/hook')}}">HOOK</a>
            </li>
        </ul>
    </li>
    <li>
        <a  class="{{request()->is('admin/inquiry') ? 'active':''}}"
        href="{{url('admin/inquiry')}}">
        <span class="nav-link-icon">
            <i class="bi bi-receipt"></i>
        </span>
