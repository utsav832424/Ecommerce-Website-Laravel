...
$(function() {
    ...
    $('#pattern_form').on('submit', function(e) {
        e.preventDefault();
        ...
        if (name == "") {
            toastr.error('Please Enter Pattern Name')
        } else {
            ...
            if (editId != 0) {
                action = action.replace("addPattern", "updatePattern");
    ...
    $('#categoriesTable tbody').on('click','.dropdown-item.edit', function() {
        $('#staticBackdropLabel').html("Edit Pattern");
    ...
    $('#AddCategoryBtn').click(function() {
        $('#staticBackdropLabel').html("Add Pattern");
