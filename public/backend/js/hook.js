...
$(function() {
    ...
    $('#hook_form').on('submit', function(e) {
        e.preventDefault();
        ...
        if (name == "") {
            toastr.error('Please Enter Hook Name')
        } else {
            ...
            if (editId != 0) {
                action = action.replace("addHook", "updateHook");
    ...
    $('#categoriesTable tbody').on('click','.dropdown-item.edit', function() {
        $('#staticBackdropLabel').html("Edit Hook");
    ...
    $('#AddCategoryBtn').click(function() {
        $('#staticBackdropLabel').html("Add Hook");
