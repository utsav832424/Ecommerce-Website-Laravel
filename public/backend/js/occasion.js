...
$(function() {
    ...
    $('#occasion_form').on('submit', function(e) {
        e.preventDefault();
        ...
        if (name == "") {
            toastr.error('Please Enter Occasion Name')
        } else {
            ...
            if (editId != 0) {
                action = action.replace("addOccasion", "updateOccasion");
    ...
    $('#categoriesTable tbody').on('click','.dropdown-item.edit', function() {
        $('#staticBackdropLabel').html("Edit Occasion");
    ...
    $('#AddCategoryBtn').click(function() {
        $('#staticBackdropLabel').html("Add Occasion");
