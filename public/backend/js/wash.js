...
$(function() {
    ...
    $('#wash_form').on('submit', function(e) {
        e.preventDefault();
        ...
        if (name == "") {
            toastr.error('Please Enter Wash Name')
        } else {
            ...
            if (editId != 0) {
                action = action.replace("addWash", "updateWash");
    ...
    $('#categoriesTable tbody').on('click','.dropdown-item.edit', function() {
        $('#staticBackdropLabel').html("Edit Wash");
    ...
    $('#AddCategoryBtn').click(function() {
        $('#staticBackdropLabel').html("Add Wash");
